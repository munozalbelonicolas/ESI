...
export default function Navbar() {
  ...
  return (
    <>
      ...
      {/* Mobile menu - Renderizado fuera del <header> para no ser contenido ni clipeado */}
      {mobileOpen && (
        <div className="navbar__mobile-menu">
          ...
          {firebaseUser && !isAdmin && (
            <>
              <Link to="/perfil" className="navbar__mobile-link" onClick={() => setMobileOpen(false)}>
                Mi perfil
              </Link>
              <Link to="/mis-ordenes" className="navbar__mobile-link" onClick={() => setMobileOpen(false)}>
                Mis pedidos
              </Link>
